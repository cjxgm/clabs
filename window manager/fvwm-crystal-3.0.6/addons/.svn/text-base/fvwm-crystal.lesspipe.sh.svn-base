...
# file stolen from gentoo and renamed to avoid possible colision.
# At that time of writing (2007 05 13), all that is distributed under
# the gentoo fundation copyright is compatible with the gpl and will remain so.
