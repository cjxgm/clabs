...
extern void starfield_LTX_init_effect_valist(SDL_Surface *s, void (*restart)(void), va_list parameters);
extern void starfield_LTX_init_effect(SDL_Surface *s, void (*restart)(void), TDEC_NODE *argument_list);
