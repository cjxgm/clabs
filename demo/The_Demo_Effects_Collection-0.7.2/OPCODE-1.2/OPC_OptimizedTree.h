...
#define __OPC_OPTIMIZEDTREE_H__
	...
	#define IMPLEMENT_IMPLICIT_NODE(baseclass, volume)													\
		...
		/* Data access */																				\
		inline_			const baseclass*	GetPos()		const	{ return reinterpret_cast<baseclass*>(mData);		}	\
		inline_			const baseclass*	GetNeg()		const	{ return (reinterpret_cast<baseclass*>(mData))+1;	}	\
	...
	#define IMPLEMENT_NOLEAF_NODE(baseclass, volume)													\
		...
		/* Data access */																				\
		inline_			const baseclass*	GetPos()		const	{ return reinterpret_cast<baseclass*>(mData);		}	\
		inline_			const baseclass*	GetNeg()		const	{ return reinterpret_cast<baseclass*>(mData2);	}	\
		inline_			udword				GetPrimitive()	const	{ return (udword)(mData>>1);			}	\
